    ...
    while True:
        ...
        for item in items:
            ...
            INSERT INTO liked_tracks (
                ...
                track_name, track_artist, album_in_library, album_id, duration_ms, popularity
            )
            ...
            """, (track_id, liked_added_at, final_added_at, now, name, artist, album_in_library, album_id, duration_ms, popularity))
